    ...
    <script type="text/javascript">
        ...
        function show() {
            ...
            ajaxObject.onreadystatechange=function () {
                ...
                if (ajaxObject.readyState==4&&ajaxObject.status==200){
                    ...
                    //遍历Json数据中每个json对象调出属性值,动态加载到下拉框,将供应商编码作为选项的值,供应商的名称展示给用户看
        ...
        function search() {
            ...
            if(goodsName==""&&tigong==""&&fukuan==""){
                ...
                //2.创建请求
                ajaxObject.open("get","BillServlet?method=fenyeQueryByTiaojian&goodsName="+goodsName+"&pid="+tigong+"&ptype="+fukuan,true);
...
<section class="publicMian ">
    ...
    <div class="right">
        ...
        <div class="search">
            <span>商品名称：</span>
            <input id="goodsName" type="text" placeholder="请输入商品的名称"/>
